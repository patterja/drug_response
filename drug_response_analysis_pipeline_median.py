...
with open (args.f, "r") as tsvfile:
    ...
    for lst_row in h_file:
        ...
        os.system('python3 /Users/zhanho/Project/SMMART/scripts/heatmap_for_384_matrix.py --i %s --l %s --h %s' % (s_file_path, args.l, heatmap_file))
...
os.system('python3 /Users/zhanho/Project/SMMART/scripts/gr50_and_curve_count_barplot.py --i %s --p %s --w %s' % (s_GRmetrics, "0.05", dir_stat_plot))

###########GR50 and drug serum concentration plot#############
os.system('python3 /Users/zhanho/Project/SMMART/scripts/barplot_for_GR50_and_serum_conc.py --i %s --c %s --s %s --w %s' % (s_GRmetrics, args.c, args.sc, dir_serum_plot))
###########GRmax plot#############
...
os.system('python3 /Users/zhanho/Project/SMMART/scripts/calculate_GR_at_serum_conc.py --m %s --gr %s --s %s --o %s' % (s_GRmetrics, s_GRvalue, args.sc, s_GRmetrics_new)) 
os.system('python3 /Users/zhanho/Project/SMMART/scripts/barplot_for_GRmax_and_GRserum.py --i %s --c %s  --w %s' % (s_GRmetrics_new, args.c, dir_GRmax_plot))
